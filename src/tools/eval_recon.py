...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=True, num_points=450000):
    ...
    with open('metrics_output.txt', 'a') as file:  # 'a' mode appends to the file
        file.write(f'accuracy: {accuracy_rec}\n')
        file.write(f'completion: {completion_rec}\n')
        file.write(f'completion ratio: {completion_ratio_rec}\n')
...
def calc_2d_metric(rec_meshfile, gt_meshfile, align=True, n_imgs=1000):
    ...
    with open('metrics_output.txt', 'a') as file:  # 'a' mode appends to the file
        file.write(f'Depth L1: {errors.mean() * 100}\n\n')
